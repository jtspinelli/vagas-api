...
export class UserRepository {
	...
	async getPagedList(page: number, limit: number, name: string | undefined, tipo: string | undefined, user: IAuthenticatedUser): Promise<Page<UserDTO | RecrutadorUserDTO>> {
